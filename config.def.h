...
//static pixman_color_t active_bg_color = HEX_COLOR(0x005577f7);
//static pixman_color_t occupied_fg_color = HEX_COLOR(0xeeeeeeff);
//static pixman_color_t occupied_bg_color = HEX_COLOR(0x222222f7);
//static pixman_color_t inactive_fg_color = HEX_COLOR(0xbbbbbbff);
//static pixman_color_t inactive_bg_color = HEX_COLOR(0x222222f7);
